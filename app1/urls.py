...
urlpatterns = [
    ...
    path('update_user/', update_user_api.as_view(), name='update_user'),
    ...
    path('create_subadmin/', CreateSubAdminView.as_view(), name='create_subadmin'),
